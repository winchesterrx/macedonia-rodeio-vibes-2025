...
const PatrocinadoresSection = () => {
  ...
  return (
    <section id="patrocinadores" className="py-20 bg-rodeo-dark">
              ...
              >
                <div className="bg-black/30 p-8 rounded-lg border border-rodeo-gold/40 flex items-center justify-center hover:border-rodeo-gold transition-colors">
                  <img 
                    src={sponsor.logo} 
                    alt={sponsor.name} 
                    className="max-h-32 max-w-[300px]"
                    onError={(e) => {
        ...
        <div className="mb-12">
          ...
          <div className="flex flex-wrap justify-center">
            {goldSponsors.map((sponsor, index) => (
              <div 
                key={index} 
                className="p-4 sm:w-1/2 md:w-1/3 lg:w-1/4 flex items-center justify-center"
              >
        ...
        <div className="relative">
          ...
          <div className="relative">
            <Button
              variant="outline"
              size="icon"
              className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-black/50 border-rodeo-gold/50 text-rodeo-gold hover:bg-rodeo-gold hover:text-black rounded-full"
              onClick={() => scroll('left')}
            >
              <ChevronLeft size={20} />
            </Button>
            ...
            <div 
              ref={carouselRef}
              className="flex overflow-x-auto scrollbar-none scroll-smooth py-4 px-10"
                ...
                >
                  <div className="bg-black/10 p-4 rounded-lg border border-rodeo-gold/20 flex items-center justify-center h-[100px] hover:border-rodeo-gold/60 transition-colors">
                    <img 
                      src={sponsor.logo} 
                      alt={sponsor.name} 
                      className="max-h-16 max-w-[160px]"
                      onError={(e) => {
            ...
            <Button
              variant="outline"
              size="icon"
              className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-black/50 border-rodeo-gold/50 text-rodeo-gold hover:bg-rodeo-gold hover:text-black rounded-full"
