...
const ContatoSection = () => {
  return (
    <section id="contato" className="py-20 bg-rodeo-darker relative">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Map */}
          <div className="rounded-lg overflow-hidden h-[400px] border border-rodeo-gold/30 shadow-lg">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14924.337516650035!2d-50.203761931622266!3d-20.147407001324993!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9498780586ab6a95%3A0xd8ff5790b56e3ee!2sMaced%C3%B4nia%2C%20SP%2C%2015620-000!5e0!3m2!1spt-BR!2sbr!4v1715622841051!5m2!1spt-BR!2sbr" 
              width="100%" 
              height="100%" 
              style={{ border: 0 }} 
          ...
          {/* Contact Info */}
          <div className="bg-rodeo-dark rounded-lg p-8 border border-rodeo-gold/30">
            <h3 className="text-2xl font-bold mb-6 text-rodeo-gold">Fale conosco</h3>
            
            <div className="space-y-6">
              <div className="flex items-start">
                <MapPin className="text-rodeo-gold mr-4 mt-1" />
                <div>
              ...
              <div className="flex items-start">
                <Phone className="text-rodeo-gold mr-4 mt-1" />
                <div>
              ...
              <div className="flex items-start">
                <Mail className="text-rodeo-gold mr-4 mt-1" />
                <div>
              ...
              <div className="flex items-start">
                <Instagram className="text-rodeo-gold mr-4 mt-1" />
                <div>
                  ...
                  <a 
                    ...
                    className="text-rodeo-gold hover:underline"
                  >
              ...
              <div className="pt-6">
                <Button 
                  ...
                  className="w-full bg-rodeo-gold hover:bg-rodeo-darkGold text-black"
                >
