        ...
        <div className="max-w-5xl mx-auto text-center flex flex-col items-center">
          ...
          <div className="mb-4 md:mb-6 flex flex-col items-center gap-4 w-full">
            <div className="flex flex-col md:flex-row md:items-center md:justify-center w-full gap-4">
              <img src={rodeioLogo} alt="Macedônia Rodeio Show" className="mx-auto max-w-[260px] md:max-w-[320px] lg:max-w-[380px] object-contain" style={{
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mt-2">
            <Button onClick={scrollToIngressos} className="bg-rodeo-gold hover:bg-rodeo-darkGold text-rodeo-dark text-lg py-7 px-10 font-bold border-2 border-rodeo-gold/80">
              GARANTIR INGRESSOS
            </Button>
            
            <Button variant="outline" onClick={() => window.open("https://wa.me/5517997799982", "_blank")} className="border-2 border-rodeo-gold text-rodeo-gold hover:bg-rodeo-gold hover:text-rodeo-dark text-lg py-7 px-10 font-bold">
              FALE CONOSCO
            </Button>
          </div>
          
          <div className="mt-20 animate-bounce-subtle">
            <button onClick={scrollToIngressos} className="text-rodeo-gold hover:text-white transition-colors focus:outline-none" aria-label="Rolar para baixo">
